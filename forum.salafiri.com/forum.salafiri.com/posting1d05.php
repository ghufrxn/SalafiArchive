...
<!-- Mirrored from forum.salafiri.com/posting.php?mode=reply&f=8&t=701 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Aug 2025 00:18:03 GMT -->
...
<title>Salafi Research Institute - Login</title>
	...
	<link rel="alternate" type="application/atom+xml" title="Feed - Salafi Research Institute" href="feed.php">			<link rel="alternate" type="application/atom+xml" title="Feed - New Topics" href="feed9d17.php?mode=topics">				
...
<form action="https://forum.salafiri.com/ucp.php?mode=login" method="post" id="login" data-focus="username">
<div class="panel">
	<div class="inner">
	...
	<div class="content">
		...
		<dl>
			...
			<dd><input type="password" tabindex="2" id="password" name="password" size="25" class="inputbox autowidth" autocomplete="off" /></dd>
							<dd><a href="ucp937e.html?mode=sendpassword">I forgot my password</a></dd>									</dl>
						<dl>
			<dd><label for="autologin"><input type="checkbox" name="autologin" id="autologin" tabindex="4" /> Remember me</label></dd>			<dd><label for="viewonline"><input type="checkbox" name="viewonline" id="viewonline" tabindex="5" /> Hide my online status this session</label></dd>
		</dl>
		
		<input type="hidden" name="redirect" value="posting1d05.php?f=8&amp;mode=reply&amp;t=701" />

		<dl>
			<dt>&nbsp;</dt>
			<dd><input type="hidden" name="sid" value="96d05cea45c629e851e3b4765a64d8d1" />
<input type="submit" name="login" tabindex="6" value="Login" class="button1" /></dd>
	...
	<div class="panel">
		...
		<div class="content">
			...
			<hr class="dashed" />
			<p><a href="ucp8319.html?mode=register" class="button2">Register</a></p>
		</div>
