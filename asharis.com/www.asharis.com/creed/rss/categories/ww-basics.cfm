...
<rss version="2.0">
<channel>
    <title><![CDATA[Asharis.Com | Basics]]></title>
    <link>http:////www.asharis.com/creed/</link>
    <description><![CDATA[Latest news and information from Asharis.Com in category "Basics"]]></description>
...
Many people will be familiar with the long lists of 'Ash'ari' scholars that are presented on websites, blogs and forums to argue that since all these scholars  ...]]></description>
	...
	<title><![CDATA[ Understanding the Battle Between the Philosophers (Aristotle, Ibn Sina, al-Farabi) and the Mutakallimoon (Jahmiyyah, Mu'tazilah, Kullaabiyyah, Ash'ariyyah, Maturidiyyah) Initiated By Jahm bin Safwaan]]></title>        
        <description><![CDATA[This article is a brief introduction to the Philosophers (Falaasifah) and the Speculative Theologians (Mutakallimoon) and the battles between them, but is intended as a very brief introduction for now so that  ...]]></description>
		
		<link>//www.asharis.com/creed/articles/ledrs-understanding-the-battle-between-the-philosophers-aristotle-ibn-sina-al-farabi-a.cfm</link>
